 ...
 */
final class Version20220430093244 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE commande ADD facture_id INT DEFAULT NULL, CHANGE client_id user_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE commande DROP facture_id, CHANGE user_id client_id INT NOT NULL');
