...
$(document).ready(function () { // Une fois que le document (base.html.twig) HTML/CSS a bien été complètement chargé...
    ...
    $('.add-another-collection-widget').click(function (e) {
        ...
        var session = list.data('commande')
    ...
    function addDeleteLink($moduleForm) {
        var $removeFormButton = $('<div class="block"><button type="button" class="button">Supprimer ce type de couteau</button></div>');
    ...
    $('.remove-session-confirm').on('click', function (e) {
        ...
        showModalConfirm(id, href, "Confirmation de suppression d'un type de couteau")
    })
